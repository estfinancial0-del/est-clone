...
export default function AssetManagementPage() {
  ...
  const services = [
    { title: "Tenant Management", desc: "Finding quality tenants, thorough screening, lease management, and renewals handled professionally." },
    { title: "Maintenance & Repairs", desc: "Proactive maintenance schedules and fast response to repair requests to protect your asset's value." },
    { title: "Financial Reporting", desc: "Detailed monthly statements, annual reports, and tax-ready documentation for your accountant." },
    { title: "Rent Reviews", desc: "Regular market rent reviews to ensure you're always receiving maximum market return." },
    { title: "Vacancy Minimisation", desc: "Strategic marketing and tenant retention strategies to keep your property occupied and earning." },
    { title: "Portfolio Growth", desc: "Ongoing advice to grow your portfolio strategically, one high-quality asset at a time." },
  ];
    ...
    <div className="min-h-screen overflow-x-hidden bg-black font-['Roboto',sans-serif]">
      ...
      <section className="relative flex min-h-[60vh] items-center justify-center bg-black px-[10px] py-[80px]">
        <div className="absolute inset-0">
          <Image src="/images/asset-management.webp" alt="" fill className="object-cover object-center opacity-25" unoptimized />
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="relative z-10 mx-auto max-w-[900px] text-center">
          <h1 className="mb-[16px] font-['Longhand'] text-[63px] font-bold leading-[1.1] text-white max-md:text-[40px]">Asset <span className="text-[#C20000]">Management</span></h1>
          <p className="text-[22px] font-['Longhand'] font-bold text-white/80">Your Property Is More Than a Rental —</p>
          <p className="text-[22px] font-['Longhand'] font-bold text-[#C20000]">It&apos;s a Wealth-Building Engine</p>
      ...
      <section className="bg-black px-[10px] py-[70px]">
        <div className="mx-auto max-w-[900px]">
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }} className="mb-[24px] text-[18px] leading-[1.7] text-white/90">
            We understand that your investment property isn&apos;t just a number — it&apos;s a vital part of your financial future. That&apos;s why we go above and beyond to ensure every detail is taken care of, so you can sleep easy knowing your asset is in expert hands.
          </motion.p>
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} viewport={{ once: true }} className="text-[18px] leading-[1.7] text-white/90">
            At <span className="text-[#C20000] font-semibold">est</span>, we manage your investment as if it were our own — so you can focus on life, while we focus on your property.
          </motion.p>
        </div>
      </section>
      ...
      <section className="relative px-[10px] py-[80px]" style={{ backgroundImage: "url('/images/wave-graphics-02-2880x1800.png')", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="relative z-10 mx-auto max-w-[1100px]">
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }} className="mb-[50px] text-center font-['Longhand'] text-[46px] font-bold text-white max-md:text-[32px]">
            What We <span className="text-[#C20000]">Manage</span> For You
          </motion.h2>
      ...
      <section className="bg-black px-[10px] py-[80px] text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }}>
          <h2 className="mb-[20px] font-['Longhand'] text-[48px] font-bold text-white max-md:text-[32px]">Let Us <span className="text-[#C20000]">Manage</span> Your Asset</h2>
          <p className="mx-auto mb-[40px] max-w-[600px] text-[18px] leading-[1.7] text-white/80">Focus on life. We&apos;ll handle everything else.</p>
