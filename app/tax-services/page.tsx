...
export default function TaxServicesPage() {
  ...
  const taxServices = [
    { title: "Property Tax Strategy", desc: "Maximise deductions on investment properties and structure ownership to minimise tax obligations." },
    { title: "Business Tax Planning", desc: "Effective business structures and strategies to reduce your tax burden and reinvest into growth." },
    { title: "SMSF Tax Compliance", desc: "Specialist tax support for self-managed super funds to keep you compliant and tax-efficient." },
    { title: "Capital Gains Planning", desc: "Strategically time asset sales and restructure holdings to reduce capital gains tax exposure." },
    { title: "Tax Return Preparation", desc: "Accurate, timely preparation of individual and company tax returns with maximum legitimate deductions." },
    { title: "ATO Liaison", desc: "We handle ATO correspondence, audits, and disputes on your behalf so you can focus on your goals." },
  ];
    ...
    <div className="min-h-screen overflow-x-hidden bg-black font-['Roboto',sans-serif]">
      ...
      <section className="relative flex min-h-[60vh] items-center justify-center bg-black px-[10px] py-[80px]">
        <div className="absolute inset-0">
          <Image src="/images/tax-services.webp" alt="" fill className="object-cover object-center opacity-25" unoptimized />
        ...
        <motion.div initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8 }} className="relative z-10 mx-auto max-w-[900px] text-center">
          <h1 className="mb-[20px] font-['Longhand'] text-[63px] font-bold leading-[1.1] text-white max-md:text-[40px]">Tax <span className="text-[#C20000]">Accounting</span></h1>
          <p className="text-[20px] leading-[1.6] text-white/80">Property Structuring &amp; Strategic Tax Deductions</p>
      ...
      <section className="bg-black px-[10px] py-[70px]">
        <div className="mx-auto max-w-[900px]">
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }} className="mb-[24px] text-[18px] leading-[1.7] text-white/90">
            At <span className="text-[#C20000] font-semibold">est</span>, we understand that tax planning is a critical component of any successful financial strategy. Whether you already have a trusted accountant or need one, we have you covered.
          </motion.p>
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.1 }} viewport={{ once: true }} className="mb-[24px] text-[18px] leading-[1.7] text-white/90">
            If you already work with a trusted tax accountant, we&apos;ll integrate seamlessly with your preferred provider — ensuring a smooth, coordinated process with no disruption to your current setup.
          </motion.p>
          <motion.p initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7, delay: 0.2 }} viewport={{ once: true }} className="text-[18px] leading-[1.7] text-white/90">
            Whether you stay with your current accountant or work with our partners, our goal remains the same: to ensure you receive timely, accurate, and strategic tax support that helps you retain more of what you earn.
          </motion.p>
        </div>
      </section>
      ...
      <section className="relative px-[10px] py-[80px]" style={{ backgroundImage: "url('/images/wave-graphics-02-2880x1800.png')", backgroundSize: "cover", backgroundPosition: "center" }}>
        ...
        <div className="relative z-10 mx-auto max-w-[1100px]">
          <motion.h2 initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }} className="mb-[50px] text-center font-['Longhand'] text-[46px] font-bold text-white max-md:text-[32px]">
            Our Tax <span className="text-[#C20000]">Services</span>
          </motion.h2>
      ...
      <section className="bg-black px-[10px] py-[80px] text-center">
        <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} transition={{ duration: 0.7 }} viewport={{ once: true }}>
          <h2 className="mb-[20px] font-['Longhand'] text-[48px] font-bold text-white max-md:text-[32px]">Keep More of <span className="text-[#C20000]">What You Earn</span></h2>
          <p className="mx-auto mb-[40px] max-w-[600px] text-[18px] leading-[1.7] text-white/80">Let&apos;s build a tax strategy that works as hard as you do.</p>
